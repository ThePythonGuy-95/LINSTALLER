...
def ubuntu():
    webbrowser.open("https://releases.ubuntu.com/24.04.2/ubuntu-24.04.2-desktop-amd64.iso")
...
def debian():
    webbrowser.open("https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.9.0-amd64-netinst.iso")
    print("Opening your browser...")
    time.sleep(7)
    clear_screen()
    print("Done! Returning to main menu...")
